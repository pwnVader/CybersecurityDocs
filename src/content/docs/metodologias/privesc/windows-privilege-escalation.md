...
- [Active Directory Enumeration & Attacks](/metodologias/active-directory/active-directory-enumeration-attacks/) — escalada de dominio una vez con foothold local
- [Password Attacks](/metodologias/exploitation/password-attacks/) — hashcat, cracking, Pass-the-Hash, PTT
- [File Transfers](/metodologias/privesc/file-transfers/) — mover winPEAS/SharpUp al target
- [Shells & Payloads](/metodologias/exploitation/shells-payloads/) — reverse shells y payloads para los exploits
- [Linux Privilege Escalation](/metodologias/privesc/linux-privilege-escalation/) — contraparte en sistemas Linux
