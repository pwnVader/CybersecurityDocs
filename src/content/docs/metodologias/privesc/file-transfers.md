...
- [Shells & Payloads](/metodologias/exploitation/shells-payloads/) — Transferir payloads y establecer reverse shells
- [Linux Privilege Escalation](/metodologias/privesc/linux-privilege-escalation/) — Transferir linpeas.sh al target
- [Windows Privilege Escalation](/metodologias/privesc/windows-privilege-escalation/) — Transferir winPEAS, PowerUp al target
- [Pivoting, Tunneling, and Port Forwarding](/metodologias/pivoting/pivoting-tunneling-port-forwarding/) — Transferir a través de pivots
- [Active Directory Enumeration & Attacks](/metodologias/active-directory/active-directory-enumeration-attacks/) — Exfiltrar NTDS.dit, BloodHound data
- [Getting Started](/metodologias/fundamentos/getting-started/) — Transferencias básicas y python http.server
