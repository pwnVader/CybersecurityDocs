...
<aside class="my-6 p-4 rounded-md border-l-4 border-[#cba6f7] bg-[#cba6f7]/5 not-prose">
  ...
  <p class="text-sm text-zinc-300">
    ¿Tienes un hash Kerberoast listo para romper? Diseña la sintaxis de máscaras óptima en el <a href="https://hacking.pwnvader.com/cracking/hashcat" class="text-[#cba6f7] hover:underline">Hashcat Mask Builder</a> de forma rápida e intuitiva.
  </p>
</aside>
